...
void sha256_final(SHA256_CTX *ctx, BYTE hash[])
{
  ...
  __m256i c = _mm256_set1_epi32(0x000000ff);

  __m256i s = _mm256_load_si256((__m256i *) ctx->state); //TODO: problem here
      // printf("Remove me !! \n");
  __m256i res ;
  //printf("\ns:");fuck(s);printf("\n");
  for (int i = 0; i < 4; ++i)
  {
    int o = (24 - i * 8);
    res =   _mm256_srli_epi32(s, o);
    //printf("res:");fuck(res);printf("\n");
    //printf("res:");fuck(res);printf("\n");
    //printf("c:");fuck(c);printf("\n");
    res =   _mm256_and_si256(res, c);
    // printf("res:");fuck(res);printf("\n");
